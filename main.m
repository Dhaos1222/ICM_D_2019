...
floorN = 5;%the number of floors
W = 480;%width
L = 533;$length
peopleNum = 200;%the number of people
threshold = 0;
iterations = 200;
delta = 0.7;%for compute phes
time = 50000;%maximum time
result = zeros(iterations+1,1);%store result
Louvre = zeros(W,L,floorN);%Louvre matrix

showAnimation = 0;%control show
